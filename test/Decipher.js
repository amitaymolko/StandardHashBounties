const Decipher = artifacts.require('Decipher')

contract('Decipher', (accounts) => {
  
  var account = accounts[0]
  const minValue = web3.toWei(0.001, 'ether')

  it('deploy and grab', async () => {
    Contract = await Decipher.new()
    // Contract = await Decipher.at('0x345cA3e014Aaf5dcA488057592ee47305D9B3e10')
